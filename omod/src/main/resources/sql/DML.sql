...
BEGIN
    ...
    BEGIN
        ...
        select
            ...
            max(if(o.obs_group_id = 164919 and o.concept_id = 1473,o.value_text,null)) as clinician_name,
            max(if(o.obs_group_id = 164919 and o.concept_id = 163556,o.value_coded,null)) as clinician_cadre,
            max(if(o.obs_group_id = 164524 and o.concept_id = 1473,o.value_text,null)) as assist_clinician_name,
            max(if(o.obs_group_id = 164524 and o.concept_id = 163556,o.value_coded,null)) as assist_clinician_cadre,
        ...
        from encounter e
                 ...
                 inner join obs o on o.encounter_id = e.encounter_id and o.concept_id in (1651,164258,163042,164204,163042,163049,164254,160047,166650,163138,163137,162871,162875,162760,162749,1473,163556,164141,1646) and o.voided=0
        where e.voided=0
        group by e.patient_id,date(e.encounter_datetime);
